...
$(".submitquote").on("click", function(event) {
	...
	var filteredObjects;
		...
		$("a").on("click", function(){
			...
			for (var j=0; j < filteredObjects.length; j++) {
				...
				$(".authorquotelist").prepend("<div id='" + newquotelist[j].num + "' class=\"quotebox\"><div class=\"author\">" + filteredObjects[j].author + "</div><div class=\"quote\"><p>\"" + filteredObjects[j].quote + "\"</p></div><div class=\"rating\"><span class=\"star\"id=\"5s\">☆</span><span class=\"star\"id=\"4s\">☆</span><span class=\"star\"id=\"3s\">☆</span><span class=\"star\"id=\"2s\">☆</span><span class=\"star\"id=\"1s\">☆</span></div></div>");
		...
		$(".ratingSort").on("click", function(){
			...
			$(".quotelist").prepend("<div class=\"quotebox\" id=\"" + newquotelist[i].num + "\"><div class=\"delqb\">X</div><div class=\"author\"><a href='#' id=\"" + newquotelist[i].author + "\">" + newquotelist[i].author + "</a></div><div class=\"quote\"><p>" + newquotelist[i].quote + "</p></div><div class=\"rating\"><span class=\"star\"id=\"5s\">☆</span><span class=\"star\"id=\"4s\">☆</span><span class=\"star\"id=\"3s\">☆</span><span class=\"star\"id=\"2s\">☆</span><span class=\"star\"id=\"1s\">☆</span></div></div>");
	...
	$(".randomquote").on("click", function(){
		...
		$(".star").on("click", function(){
			var idnum;
			starrating = $(this).attr("id");
			console.log('rst',starrating);
			idnum = $(this).parent().parent().attr("id");
			console.log('nqlidnum',idnum);
			newquotelist[idnum]["rating"] = starrating;
